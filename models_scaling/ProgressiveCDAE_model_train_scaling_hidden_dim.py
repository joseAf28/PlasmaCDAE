...
def train_system(seed, hidden_dim_map):
...
if __name__ == "__main__":
    ...
    file_name = "cdae_results_scaling_hidden_dimV3.txt"
    seed_vec = np.arange(1, 100, 20)
    hidden_dim_map_vec = np.arange(100, 3000, 300)
    ...
    with open(file_name, "w") as f:
        ...
        f.write("Hidden dim map: " + str(hidden_dim_map_vec) + "\n\n")
    ...
    for i, hidden_dim_map in enumerate(hidden_dim_map_vec):
        ...
        with open(file_name, "a") as f:
            f.write("Hidden dim map: " + str(hidden_dim_map) + "\n")
